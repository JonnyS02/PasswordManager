...
<div class="bg-light justify-content-center d-flex align-items-center"
    ...
    <h1 class="header">
        ...
        <sup><span class="PRO"
                   style="font-family: 'Agency FB','Smooch Sans','Arial',serif;  color: white; background-color: #00bcff;padding-left: 5px;padding-right: 5px;">Pro</span></sup>
